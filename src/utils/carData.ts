export const CARS =[
  {
    ...
    "description": "The 2022 Honda CR-V is a compact SUV that offers a blend of comfort, efficiency, and advanced technology. It features a spacious interior with high-quality materials, making it ideal for families and daily commuting. The CR-V comes equipped with Honda Sensing, a suite of safety and driver-assistive technologies, including collision mitigation braking, road departure mitigation, adaptive cruise control, and lane-keeping assist. Under the hood, it offers a fuel-efficient engine option with smooth performance. The CR-V also boasts a user-friendly infotainment system with Apple CarPlay and Android Auto integration. With its versatile cargo space and comfortable ride, the 2022 Honda CR-V is a practical choice for those seeking a reliable and stylish SUV."  
  },
  {
    "id": 2,
